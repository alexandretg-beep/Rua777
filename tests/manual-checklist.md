# Checklist manual — Sprint 01

## Fundação

- [ ] O `index.html` abre com duplo clique.
- [ ] O canvas aparece sem tela branca.
- [ ] O cenário provisório é exibido.
...
- [ ] Nila tem 16 anos.
- [ ] Nila e Izabel não foram confundidas.
- [ ] Helena Padilha está com o nome correto.
- [ ] Placeholders estão identificados.
- [ ] Nenhum fato novo foi apresentado como canônico.
